    ...
    implements Serializable
{
    ...
    protected String recommendedLoyaltyPoint;

    @OWLObjectProperty(iri = Vocabulary.s_p_recommendedAmount)
    @ParticipationConstraints({
            @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, min = 1, max = -1),
            @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    protected Value recommendedAmount;

    @OWLObjectProperty(iri = Vocabulary.s_p_compensation)
    @ParticipationConstraints({
            @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, min = 1, max = -1),
            @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    protected Value compensation;

    public String getRecommendedLoyaltyPoint() {
        return recommendedLoyaltyPoint;
    }

    public void setRecommendedLoyaltyPoint(String recommendedLoyaltyPoint) {
        this.recommendedLoyaltyPoint = recommendedLoyaltyPoint;
    }

    public Value getRecommendedAmount() {
        return recommendedAmount;
    }

    public void setRecommendedAmount(Value recommendedAmount) {
        this.recommendedAmount = recommendedAmount;
    }

    public Value getCompensation() {
        return compensation;
    }

    public void setCompensation(Value compensation) {
    ...
    public Value getCompansation() {
        return compansation;
    }

    public void setCompansation(Value compansation) {
